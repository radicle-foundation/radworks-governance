...
_Formal Review_ is the last chance for the community to propose changes and give feedback on the proposal before it moves to an on-chain vote. During _Formal Review_, proposal authors are required to publish an updated version of their proposal on the forum taking into account feedback from the *Discussion* phase. If applicable, the proposal must be accompanied by executable on-chain code for the community to review. See this template [INSERT LINK WHEN READY] for how the code should be presented. Proposals in this stage should be posted under the [Active Proposals](https://community.radworks.org/c/governance/proposals/18) category on the forum. 
