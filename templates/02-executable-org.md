...
>❗️Please include the following text in the budget section: The [INSERT ORG] Org - also the "Award Recipient" of Radworks, if this proposal is passed - hereby agrees to use the amount granted by Radworks in support of fulfilling the purpose outlined in the "Purpose" section above. The Award Recipient understands and acknowledges that the awarded amount may be used only for this Purpose. Furthermore, any funds that go unused in the calendar year outlined in this proposal (INSERT PROPOSAL YEAR) will either be returned to the Radworks Treasury (by March [INSERT FOLLOWING YEAR]) or rolled over into and applied towards the Org's [INSERT FOLLOING YEAR] grant from Radworks.
